...
h2. A demo of our Enki version could be found at "blog.agile-pandas.com":http://blog.agile-pandas.com 

h3. Changes:
* Main layout and admin layout are completely different (For a preview see top)
* Haml/Sass (some views still need to be updated)
* i18n (some views still need to be updated)
* Post-preview-as-you-type
* Divise instead of OpenID
* Draft post
...
* Get rid of ERB (fully implement Haml)
* Clean up JS
* Change the way drafting behaves (current:= Leave published at blank)
* Simple statistics (such as blog-post views)
* Google Analytics
